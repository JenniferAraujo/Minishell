...
=======
/*   Updated: 2023/10/27 17:37:35 by dinoguei         ###   ########.fr       */
>>>>>>> main
/*                                                                            */
/* ************************************************************************** */
...
//* Flag = 2: juntar a str in quotes na mesma string que a ultima
//*  do arr before e juntar o arr after na string seguinte
...
char	**ft_arrstrarrjoin(char	**arr1, char	*str, char	**arr2)
{
	...
	if (str)
	{
		...
		arr1[arr1_len -1] = ft_strjoinfree3(arr1[arr1_len - 1], arr2[0]);
	ft_arrlcpy(new_arr, arr1, (arr1_len + 1));
	ft_arrlcpy(new_arr + arr1_len, arr2 + 1, (arr2_len + 1));
	return (new_arr);
}

//* Vai dar join ao que foi expandido
