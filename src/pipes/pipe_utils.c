...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/09/22 17:20:14 by jede-ara          #+#    #+#             */
/*   Updated: 2023/09/22 17:20:14 by jede-ara         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//*Esta função redireciona o stdout para o writing
//* end do pipe (fd[1]) e executa o comando
...
//*Esta função redireciona o stdin para o reading end
//* do pipe (fd[0]) e executa o comando
